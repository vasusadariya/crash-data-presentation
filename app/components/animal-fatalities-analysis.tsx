  ...
  return (
    <Card className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-cyan-500/30 p-6 hover:border-cyan-500/60 transition-all duration-500 w-full">
      <div className="space-y-4">
        <div>
          <h3 className="text-xl font-bold text-cyan-300 mb-2">Assessment of Animal Fatalities</h3>
          <p className="text-sm text-neutral-400">Impact on wildlife in reported road accidents</p>
        </div>
        ...
        <div className="relative">
          <div className="absolute top-4 right-4 p-3 bg-neutral-800/80 border border-cyan-500/30 rounded-lg backdrop-blur-sm z-10">
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-300">2307</div>
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-cyan-500/20">
          {data.map((item, index) => (
            <div key={index} className="p-4 bg-neutral-700/50 rounded border border-cyan-500/20 hover:bg-neutral-600/50 transition-colors">
              ...
              <div className="text-sm text-neutral-500">{item.count} cases</div>
            </div>
          ))}
        </div>
